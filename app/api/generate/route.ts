...
[절대 규칙]
1. 답변은 **반드시 사용자가 입력한 문장의 언어와 동일한 언어**로만 작성할 것.
2. 인사말, 서론, 따옴표(""), 마크다운 기호 등을 절대 포함하지 말고 오직 이어질 문장만 출력할 것.
3. 길이는 무조건 1~2문장 이내로 끝낼 것.
4. 중간에 글을 끊지 말고 온점이나 명확한 종결어미로 끝낼 것.`,
    });
